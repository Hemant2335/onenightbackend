...
exports.getWalletPass = exports.redeemCoupon = exports.getUserCoupons = exports.getEventDetails = exports.getPublicEventDetails = exports.bookTicket = exports.addTicket = exports.getUserEvents = exports.getUserTickets = exports.getAllPublicEvents = void 0;
...
const getUserEvents = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const userCoupons = yield prisma_1.default.userCoupon.findMany({
            where: { user_id: userId },
            include: {
                coupon_template: {
                    include: {
...
const addTicket = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        // Link ticket to user
        const userTicket = yield prisma_1.default.userTicket.create({
            data: {
                user_id: userId,
                ticket_id: ticket.id,
            },
        ...
        const couponTemplates = yield prisma_1.default.coupon.findMany({
...
const getEventDetails = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        res.json({
            success: true,
            event: Object.assign(Object.assign({}, event), { coupons: coupons }),
        });
    }
    catch (error) {
...
const getUserCoupons = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const userId = req.user.user_id;
        if (!userId) {
            return res.status(404).json({ error: "User not found" });
...
const getWalletPass = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { couponId } = req.params;
        const userId = req.user.user_id;
        if (!userId) {
        ...
        const walletPassData = {
            apple: {
                ...
                url: `https://wallet.apple.com/passes?data=${encodeURIComponent(JSON.stringify({
                    passTypeIdentifier: process.env.APPLE_PASS_TYPE_ID || "pass.com.onenight.coupon",
            ...
            google: {
                ...
                url: `https://pay.google.com/gp/v/save/${encodeURIComponent(JSON.stringify({
        ...
        try {
            const addToWalletApiKey = process.env.ADD_TO_WALLET_API_KEY ||
                "010d3e53-35a0-3125-96dc-2995723a9caf";
            const addToWalletBase = process.env.ADD_TO_WALLET_BASE_URL || "https://app.addtowallet.co";
            if (addToWalletApiKey && typeof fetch === "function") {
                ...
                if (logoUrl.includes("google.com/url") ||
                    heroImage.includes("google.com/url")) {
                    console.warn("Invalid image URLs detected, skipping addtowallet.co integration");
                    throw new Error("Invalid image URLs");
                }
                const payload = Object.assign(Object.assign({ logoUrl, cardTitle: "One Night", header: `${couponData.title} • Code: ${couponData.code}`, textModulesData: [
                        {
                            id: "discount",
                            header: "Discount",
                    ...
                    ], barcodeType: "QR_CODE", barcodeValue: couponData.code, barcodeAltText: "Show this code at redemption", hexBackgroundColor: "#1E2022", appleFontColor: "#FFFFFF", heroImage, googleHeroImage: heroImage, appleHeroImage: heroImage }, (couponData.validFrom && { startDate: couponData.validFrom })), (couponData.validUntil && { endDate: couponData.validUntil }));
                const response = yield fetch(`${addToWalletBase}/api/card/create`, {
                    method: "POST",
                    headers: {
                ...
                if (response.ok) {
                    ...
                    const errText = yield response.text().catch(() => "Unknown error");
                    console.warn("addtowallet.co API error:", errText);
                }
            }
        }
        catch (thirdPartyErr) {
            console.warn("addtowallet.co integration failed, using fallback URLs:", thirdPartyErr);
        }
        res.json({
            success: true,
...
exports.getWalletPass = getWalletPass;
